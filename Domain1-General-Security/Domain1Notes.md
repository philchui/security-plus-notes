...
This is the P-D-D-C-C-D model:
	1	Preventive — stop an attack
	◦	Firewall allow/deny
	◦	Locked doors
	◦	MFA
	◦	Anti-tailgating mantraps
	◦	Hardening
	2	Deterrent — discourage attacker
	◦	Warning signs
	◦	Legal banners
	◦	Visible cameras
	◦	Guards at the front desk
	3	Detective — discover an event
	◦	SIEM alerts
	◦	IDS signatures
	◦	Log reviews
	◦	Motion sensors
	4	Corrective — restore after an event
	◦	Backups
	◦	System reimage
	◦	Fire extinguisher
	◦	Incident response steps
	5	Compensating — alternative control when primary isn’t possible
	◦	Temporary firewall block until patch is installed
	◦	Extra guards
	◦	Separation of duties when technical enforcement is unavailable
	6	Directive — instruct expected behavior
	◦	Training
	◦	SOPs
	◦	“Authorized personnel only” signs
Memory Pairing Trick: Controls are ALWAYS both:
...
A. Identification
You claim an identity. Examples:
	•	Username
	•	Email
...
Factors:
	...
	2	Something you have (token, smartcard)
	3	Something you are (biometrics)
	4	Somewhere you are (geo/IP)
...
A. ZTA Core Principles
	...
	2	Least privilege everywhere Users and devices get the minimum required access.
	3	Assume breach Design systems as if attackers are already inside.
	4	Micro-segmentation Break networks into granular zones; limit lateral movement.
	5	Continuous verification Evaluate identity, device posture, context every time a request is made.
	6	Encrypt everything Data in transit + at rest; strong mutual TLS where possible.
...
High-risk → require more MFA Low-risk → frictionless allow Suspicious → deny or isolate
...
Prevent vehicles from approaching building entrances. Key term: stand-off distance.
2. Fences
	•	Anti-climb
	•	Height matters
	•	Razor wire
...
B. Core Benefits
	1	Stability — avoid breaking production
	2	Accountability — who changed what, when, why
	3	Communication — notify all impacted teams
	4	Compliance — required by industry frameworks
	5	Recovery Assurance — rollback validated
...
Covering 1.10 Obfuscation / Steganography / Tokenization / Masking and 1.11 Blockchain Concepts.
...
These four appear together in exam questions. You must know the differences cold, because Security+ often tests them in comparison.
