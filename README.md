# CompTIA Security+ Notes (Professor Messer Summary)
...
Attack types, malware, vulnerabilities, threat actors, threat intelligence, hardening.

### **Domain 3 – Security Architecture**
Network architecture, secure protocols, OS hardening, virtualization, cloud models.

### **Domain 4 – Security Operations**
Monitoring, SIEM, logging, incident response, forensic basics, secure admin practices.
